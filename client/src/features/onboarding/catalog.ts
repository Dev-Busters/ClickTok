...
export const ONBOARDING_GOALS: readonly OnboardingGoalDef[] = [
  ...
  { id: "reach_700", label: "REACH 700 FOLLOWERS", benefit: "Unlock VIRAL letters", requirement: { kind: "total_followers", amount: BALANCE.onboarding.minorFollowerGoal1 }, reward: { coins: BALANCE.onboarding.goalCoins.reach700 }, reveals: "virality", teachId: "virality_first_letter" },
